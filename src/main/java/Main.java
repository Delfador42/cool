...
*/
    ...
    @ResponseBody
    String login(@RequestParam(required=false, name = "name") String name) {
...
"            </div>"+
"            <div class='user-box'>"+
"                <input type='text' name='name' value='' placeholder='password'><br>"+
"            </div>"+
...
"";
    	...
    	try {
			Template t = new Template("login", new StringReader(template), new Configuration());
